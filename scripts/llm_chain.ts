...
import { BasePromptTemplate } from 'langchain/prompts'; // '../prompts/base.js';
import { BaseLanguageModel } from 'langchain/base_language'; // '../base_language/index.js';
import { ChainValues, Generation, BasePromptValue } from 'langchain/schema'; // '../schema/index.js';
import {
  BaseLLMOutputParser,
  BaseOutputParser,
} from 'langchain/schema/output_parser'; // '../schema/output_parser.js';
import { SerializedLLMChain } from 'langchain/chains'; //'./serde.js';
import { CallbackManager } from 'langchain/callbacks'; //'../callbacks/index.js';
import {
  // BaseCallbackConfig,
...
// import { NoOpOutputParser } from 'langchain/output_parsers/noop.js'; //'../output_parsers/noop.js';
